...
//       const getid=_id;
//  const events = event.filter((item)=>item._id===getid)
// // console.log(events);
//  useEffect(() => {
...
//       </div>
//       {events.map((events)=>
//       <div className="grid grid-cols-1 lg:grid-cols-7 mt-24 max-w-screen-xl mx-auto px-4 " style={{display:'flex'}}>
...
//           <div className="grid grid-cols-1 md:flex justify-center gap-3 my-6" style={{display:'flex'}}>
...
//           <div className="bg-base-200 py-5 lg:w-96" style={{paddingLeft:'50px'}}>
...
//                     <h2 className="text-2xl font-semibold">surya</h2>
//                     <h3 className=" text-lg">CEO</h3>
//                   </div>
//                 </div>
//               </div>
      ...
      {events.map((events)=>
       ...
       <Col sm={8}>
          ...
          <div>
            ...
            <div className="flex text-sm md:flex-row flex-col gap-4 border-y py-4 my-6 justify-around max-w-[840px]">
              <div className="flex gap-7 md:gap-16 lg:gap-24">
                <div className="flex gap-3 items-center ">
                  <PiListDashesBold className="text-red-500 text-xl" />
                  <div>
                    <p className="font-semibold">Event Type</p>
          ...
          <div className="grid grid-cols-1 md:flex justify-center gap-3 my-6" style={{display:'flex'}}>
            <Link to={`/payment/${events._id}`}>
              <button className=" px-4 py-2 text-2xl w-60 text-center text-white rounded-md flex items-center  gap-2" style={{backgroundColor:'#9C0C0D'}}>
                <IoTicketOutline className="text-3xl" />
                Get The Ticket
       ...
       <Col sm={4}>
       <h2 className=" px-4 py-2 text-2xl w-60 text-center text-white rounded-r-md flex items-center gap-2" style={{backgroundColor:'#9C0C0D'}}>
              <PiNotebookDuotone className="text-3xl" />
             Recent Event
          </h2>
