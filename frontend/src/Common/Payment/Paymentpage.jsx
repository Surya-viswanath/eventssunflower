...
// import useAxiosPublic from '../../hooks/useAxiosPublic';
// import { useAuth } from '../../auth/AuthContext';
// // import razorpay from './razorpay'; // Import initialized Razorpay instance
...
//     currency: 'INR' // Change to your preferred currency (INR for Indian Rupees)
//   };

//   const handlePayment = async () => {
//     try {
//       const response = await axios.post('http://localhost:4000/order', paymentInfo);
//       const options = {
...
//         description: 'Event Ticket Purchase', // Replace with description
//         order_id: response.data.orderId, // Use orderId from your server response
//         handler: function (response) {
//           console.log(response);
//           Swal.fire({
//             title: 'Payment Successful!',
//             text: 'Redirecting to event details page...',
//             icon: 'success'
//           }).then(() => {
...
//           contact: 'XXXXXXXXXX' // Replace with customer's phone number
//         },
//         notes: {
//           address: 'Your company address' // Replace with your company address
//         },
//         theme: {
//           color: '#3399cc' // Replace with preferred theme color
//         }
//       };
